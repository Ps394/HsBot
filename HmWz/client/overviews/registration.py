...
class RegistrationOverview(BasicOverview):
    ...
    max_registrations_per_list : int = 40
    ...
    def __init__(self, guild, services, client):
        ...
        self.registration_embed : Optional[Embed] = None
        self.registration_view : Optional[View] = None

        self.registrations_embeds : Optional[tuple[Embed]] = None
        self.registrations_list : Optional[tuple[str]] = None
    ...
    async def update_registrations(self) -> bool:
        try:
            if self.is_valid_setup:
                ...
                logger.debug(f"{self.log_context} Updating registrations list overview: {len_embeds} embeds to update/create, {len_records} existing records.")
