...
async def remove(interaction: Interaction, role: str):
    MIN_ROLES = 1
    MESSAGES = {
        "ERROR": f"{Emojis.ERROR} Fehler beim Entfernen der Rolle aus der WZ-Registrierung.",
        "UNKNOWN_ROLE": f"{Emojis.WARNING} Unbekannte Rolle. Bitte wähle eine Rolle aus der Autovervollständigung aus.",
        "MIN_ROLES": f"{Emojis.WARNING} Es muss mindestens eine Rolle für die WZ-Registrierung festgelegt sein.",
        "SUCCESS": f"{Emojis.SUCCESS} Rolle {{role_name}} wurde aus der WZ-Registrierung entfernt.",
        "UNEXPECTED": f"{Emojis.ERROR} Unerwarteter Fehler beim Entfernen der Rolle aus der WZ-Registrierung."
    }
