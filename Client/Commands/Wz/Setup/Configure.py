...
async def configure(interaction: Interaction, channel: TextChannel, role: Optional[Role]=None):
    MESSAGES = {
        "SUCCESS": f"{Emojis.SUCCESS} WZ-Registrierung wurde erfolgreich eingerichtet. \nKanal: {{channel_name}}",
        "ERROR": f"{Emojis.ERROR} Fehler beim Einrichten der WZ-Registrierung.",
        "ERROR_ROLE_HIERARCHY": f"{Emojis.ERROR} Die angegebene Rolle ist höher als die Bot-Rolle. Bitte wähle eine andere Rolle oder ändere die Bot-Rollenhierarchie.",
        "ERROR_NO_CONFIGURED_ROLE": f"{Emojis.ERROR} Es muss mindestens eine Rolle für die WZ-Registrierung festgelegt sein, wenn kein Kanal konfiguriert ist."
    }
