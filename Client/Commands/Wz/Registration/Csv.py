...
async def csv(interaction: Interaction, ephemeral: bool = True):
    MESSAGES = {
        "SUCCESS": f"{Emojis.SUCCESS} Die Registrierungen wurden als CSV-Datei exportiert.",
        "ERROR": f"{Emojis.ERROR} Fehler beim Exportieren der Registrierungen als CSV-Datei.",
        ...
        "NO_REGISTRATIONS": f"{Emojis.WARNING} Es sind keine Registrierungen zum Exportieren vorhanden."
    }
